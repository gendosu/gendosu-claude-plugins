...
- **Distribution**: Plugin source migrated from local path to GitHub repository
  - Marketplace configuration now references `gendosu/agent-skills` repository
  - Homepage and repository URLs updated to point to agent-skills repository
